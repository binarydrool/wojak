      ...
      <div className="bg-wojak-card border border-wojak-border rounded-2xl p-5 sm:p-8">
        ...
        <div className="text-gray-300 leading-relaxed space-y-5">
          ...
          <div className="bg-wojak-green/10 border border-wojak-green/30 rounded-xl p-4">
            <p className="text-wojak-green font-semibold mb-1"><svg className="inline w-4 h-4 -mt-0.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg> WOJAK&apos;s LP is locked</p>
            <p className="text-sm">
